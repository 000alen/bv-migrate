...
export function BobMessage({ message, subtext }: BobMessageProps) {
  return (
    <div className="flex items-start gap-3 max-w-xl animate-fade-in">
      <div
        className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center text-xl select-none bg-brand-purple"
      >
        👷
      </div>
      <div
        className="rounded-2xl rounded-tl-none px-4 py-3 shadow-sm bg-brand-bg"
      >
